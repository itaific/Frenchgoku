...
struct ReadingMaterial reading_material_table[] = {
    /* WELCOME ("Rhythm Tengoku Welcome") */ {
        ...
        /* BODY ----------------------------------------------------------- */
            "SalutationsáR!\n"
            "\n"
            "Nous vous remercions d'avoir achetáQ\n"
            "Rhythm Paradise Advance.\n"
            "Oh... un ami vous l'a pràÆtáQáR? Et... i-il est d'occasionáR?!\n"
            "Bref, nous sommes tráas honoráQs de voir\n"
            "que vous vous àÆtes intáQressáQ ág notre jeuáR!\n"
            "Nous sommes tráas heureux d'avoir fait votre\n"
            "connaissance et espáQrons que vous passerez\n"
            "beaucoup de bons moments avec ce jeu et que\n"
			"vous continuerez d'y jouer longtempsáR!\n"
            "Merci beaucoupáR!",
        /* STYLE ---------------------------------------------------------- */
    ...
    /* MANUAL ("Handling Instructions") */ {
        ...
        /* BODY ----------------------------------------------------------- */
            "Comment joueráR:\n"
            "\n"
            "Eh bien, c'est un jeu assez simple ág comprendre.\n"
            "Qu'est-ce que je peux dire...?\n"
            "Ah, siáR! L'idáQe c'est de jouer en rythme avec la\n"
            "musique, alors laissez-vous porter par le rythmeáR!\n"
			"C'est àπa, mon conseil.\n"
            "Voilág c'est tout, heureux de vous rencontrer sinonáR! ",
        /* STYLE ---------------------------------------------------------- */
    ...
    /* CAFE ("More Than a Barista") */ {
        /* TITLE ---------------------------------------------------------- */
            "Message du patron",
        /* BODY ----------------------------------------------------------- */
            "Je suis propriáQtaire et gáQrant d'un cafáQ.\n"
            "J'imagine qu'on dire que je suis le patron ici.\n"
            "En tout cas, àπa tourne bien gráuce aux habituáQs.\n"
            "Et heu, si vous vous demandez... oui, je suis un chien.\n"
            "J'ai beaucoup de clients qui aiment áQcouter\n"
            "de la musique. La plupart ont d'ailleurs un excellent\n"
            "sens du rythme, et certains d'entre eux ont màÆme\n"
            "ráQussi ág obtenir tous les ParfaitsáR!\n"
            "Ils ne cessent de m'impressionner.\n"
            "J'ai peut-àÆtre l'air professionnel derriáare mon\n"
            "comptoir, mais pour àÆtre honnàÆte,\n"
			"c'est juste une apparence.\n"
            "C'est un peu embarassant mais...\n"
            "quand je ne travaille pas, je suis constamment plongáQ\n"
            "dans ma musique, avec mes áQcouteurs pour chien.\n"
            "HáQ, on se refait pasáR!\n"
			"J'ai toujours besoin d'un son pour m'accompagner.\n"
            "C'est comme àπa, ahaháR!\n"
            "D'ailleurs àπa m'arrive de sortir de temps en temps.\n"
			"Si vous me croisez, s'il vous plaà≤t, caressez-moiáR!\n"
            "áf bientà∂táR!",
        /* STYLE ---------------------------------------------------------- */
    ...
    /* RHYTHM_TWEEZERS ("Letter to the Editor") */ {
        ...
        /* BODY ----------------------------------------------------------- */
            ...
            "RáQcemment, tous mes láQgumes se sont mis\n"
            "ág avoir des poilsáR! J'en avais peuráR!\n"
            "Et je ne pouvais màÆme pas les vendreáR!\n"
			"J'ai tentáQ de les áQpiler,\n"
            "mais impossible de leur rendre la\n"
            "peau douce comme ils áQtaient avant.\n"
			"Et puis, pour me changer les idáQes,\n"
            "j'ai mis de la musique.\n"
			"Et croyez-le ou nonáR: avant de\n"
            "m'en rendre compte, j'áQpilais mes láQgumes en rythme.\n"
            "Et cette fois, ils áQtaient tout lissesáR!\n"
			"C'áQtait màÆme plutà∂t amusantáR!\n"
            "Le pouvoir de la musique, c'est\n"
            "vraiment quelque chose. Vous aussi, vous devriez\n"
			"essayer d'áQpiler vos láQgumesáR!\n"
            "Je recommandeáR!",
        /* STYLE ---------------------------------------------------------- */
            /* GFX */ reading_style_train_gfx_table,
            /* BGM */ &reading_style_train_bgm
    ...
    /* NIGHT_WALK ("Night Walk Riddle") */ {
        ...
        /* BODY ----------------------------------------------------------- */
            ...
            "Å·áRBalade nocturneáRÅ‚áR? Il a l'air d'àÆtre obsáQdáQ par\n"
            "la musique. Apparemment il travaille dedans, et aurait\n"
            "eu un rà∂le dans ce jeu via certaines relations.\n"
            "Je l'ai croisáQ en ville l'autre soir, il m'a juste dit\n"
            "Å·áRJ'adore la musiqueáR!áRÅ‚ et il s'est volatilisáQ\n"
			"en haut d'un escalier.\n"
            "J'espáare le revoir un jour... Quand j'y pense, je ne\n"
            "sais màÆme pas comment il s'appelle...\n"
            "\n"
            "Voici une question pour vousáR!\n"
            "Comment s'appelle-t-iláR?\n"
            "\n"
            "\001C" "\0031" "\001m" "á@áAáBáC-áCáBáD\n"
            "\001L" "\0030" "\001s" "\n"
            "Trouvez quelle lettre remplace quel chiffre,\n"
            "et vous serez capable de lire son nomáR!\n"
            "Le texte suivant pourrait vous aider...\n"
            "\n"
            "\0031" "\001m" "\001C" "Secret du mini-jeu\n"
            "\0031" "\001m" "\001C" "Å· Question de rythme Å‚\n"
            "\0030" "\001s" "\001C" "\n"
            "D" "\0031" "\001m" "áB" "\0030" "\001s" "ns ce mini-jeu, le joueur doit a" "\0031" "\001m" "á@" "\0030" "\001s" "pu" "\0031" "\001m" "áC" "\0030" "\001s" "er\n"
            "\0030" "\001s" "sur " "\0031" "\001m" "áA" "\0030" "\001s" "es boutons auta" "\0031" "\001m" "áD" "\0030" "\001s" "t de fois que le\n"
            "\0030" "\001s" "práQse" "\0031" "\001m" "áD" "\0030" "\001s" "tateur. Mais s'il matr" "\0031" "\001m" "áB" "\0030" "\001s" "que les boutons\n"
            "\0030" "\001s" "tráas tráas vite ág la " "\0031" "\001m" "á@áAáB" "\0030" "\001s" "ce, que" "\0031" "\001m" "áA" "\0030" "\001s" "que chose\n"
            "\0030" "\001s" "d'intáQressa" "\0031" "\001m" "áD" "\0030" "\001s" "t pourrait se " "\0031" "\001m" "á@" "\0030" "\001s" "roduireáR!",
        /* STYLE ---------------------------------------------------------- */
            /* GFX */ reading_style_train_gfx_table,
            /* BGM */ &reading_style_train_bgm
        /* ---------------------------------------------------------------- */
